...
with st.container():
    st.markdown(
        """
        <div style="background-color:#f7f9fa; padding:20px 30px; border-radius:10px; border-left: 6px solid #4A90E2; margin-bottom: 25px;">
        <h4 style="color:#4A90E2;">🔧 Filter Options</h4>
        """,
        unsafe_allow_html=True
    )
